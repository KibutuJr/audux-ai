    ...
    <div key={gen.id} className="mb-4 break-inside-avoid">
        ...
        <div className={`${gen?.aspectRatio === '9:16' ? 'aspect-9/16':'aspect-video'} relative overflow-hidden`}>
            ...
            {!forCommunity && (
                ...
                className="absolute right-3 top-3 sm:opacity-0 group-hover:opacity-100 transition flex iems-center gap-2">
        ...
        <div className="p-4">
            ...
            <div className="flex items-start justify-between gap-4 ">
                ...
                <div className="text-right">
                    <div className="mt-2 flex flex-col items-end gap-1">
                        <span className="text-ts px-2 py-1 bg-white/5 rounded-full">Aspect: {gen.aspectRatio}</span>
                    </div>
            ...
            {gen.userPrompt && (
                <div className="mt-3">
                    <div className="text-xs text-grat-300">{gen.userPrompt}</div>
                </div>
            )}
