  ...
  return (
    <div className="min-h-screen text-white p-6 md:p-12 mt-28">
        <form onSubmit={handleGenerate} className="max-w-4xl mx-auto mb-40">
            ...
            description="Upload your model and product images to generate stunning UGC, short-form video and social media posts"
             />
             ...
             <div className="flex gap-20 max-sm:flex-col items-start justify-between">
                ...
                <div className="w-full">
                    ...
                    <div className="mb-4 text-gray-300">
                        ...
                        <input type="text" id="productName" value={productName} onChange={(e)=>setProductName(e.target.value)} placeholder="Enter Name of the Product Here" required 
                        className="w-full bg-white/3 rounded-lg border-2 p-4 text-sm border-violet-200/10 focus:border-violet-500/50 outline-none transition-all"/>
                    </div>
                    <div className="mb-4 text-gray-300">
                        ...
                        <textarea id="productDescription" rows={4} value={productDescription} onChange={(e)=>setProductDescription(e.target.value)} placeholder="Enter the descrption of the product here"
                    ...
                    <div className="mb-4 text-gray-300">
                        ...
                        <textarea id="userPrompt" rows={4} value={userPrompt} onChange={(e)=>setUserPrompt(e.target.value)} placeholder="Describe how you want your narration to be"
                            className="w-full bg-white/3 rounded-lg border-2 p-4 text-sm border-violet-200/10 focus:border-violet-500/50 outline-none resize-none transition-all"/>
                    </div>
