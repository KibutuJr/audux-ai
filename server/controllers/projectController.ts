...
import { GenerateContentConfig, HarmBlockThreshold, HarmCategory, Operations } from '@google/genai';
import fs from 'fs';
...
export const createProject  = async (req: Request, res: Response) => {
    ...
    try {
        ...
        const prompt = {
            ...
            Make the person astand in professional studio lighting.
            Output ecommerce-quality phot realistic imagery.
            ${userPrompt}`
        }
...
export const createVideo = async (req: Request, res: Response) => {
    ...
    try {
        ...
        const prompt = `make the person showcase the product which is ${project.productName} ${project.productDescription && `and Product Description: $
            ...
            //create the images direcory if it doesnt exist
